...
if __name__ == "__main__":
    means, means_instantaneous_freq, means_instantaneous_amp = example_hht()
    print(means)
    print(means_instantaneous_freq)
    print(means_instantaneous_amp)
    import matplotlib.pyplot as plt
    plt.plot(means_instantaneous_freq)
    plt.show()
